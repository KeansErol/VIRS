  ...
  <script>
    ...
    function generateCertificate() {
      ...
      $("form").on("submit", function(event) {
        ...
        $.ajax({
          url: "function/cValidate.php",
          type: "POST",
          data: {
            gen_fullNameSend: gen_fullName
          },
          success: function(result) {
            ...
            if (result == "exist") {
              swal({
                title: "Warning!",
                text: "Barangay Citizen has an active case.",
                icon: "warning",
                button: "OK",
              });
              ...
              var _el = $('<div>')
              _el.append(_h)
              _el.append("<img src='../../assets/images/brgy-clearance-template.png' height='980px' width='740px' style='position: absolute;'>");
              _el.append(_p)
